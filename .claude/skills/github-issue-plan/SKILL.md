...
> **Recommended entry point**: `/grill-with-docs issue <N>` — full grilling session that covers all 4 impact areas (Actions, Workflows, Consumer Impact, Docs), posts a structured comment, and flips labels to `ready-for-work`.
